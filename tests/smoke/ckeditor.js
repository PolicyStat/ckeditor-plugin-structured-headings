...
(function () {
  ...
  bender.test({
    ...
    'Command Active but Off Inside Header Tag': function() {
        ...
        assert.areSame( CKEDITOR.TRISTATE_OFF, testCommand.state, 'autoNumberHeading OFF in H1' );
    ...
    'Command Active and On Inside AutoNumbered Header': function() {
        ...
        assert.areSame( CKEDITOR.TRISTATE_ON, testCommand.state, 'autoNumberHeading ON in H1' );
    ...
    'Command Disabled Outside Header': function() {
        ...
        assert.areSame( CKEDITOR.TRISTATE_DISABLED, testCommand.state, 'autoNumberHeading DISABLEd in P' );
